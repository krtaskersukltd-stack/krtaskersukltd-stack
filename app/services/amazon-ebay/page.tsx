...
const serviceFeatures = [
  {
    ...
    "content": "Professional, end-to-end strategy, execution, and optimization for Amazon Seller Setup to maximize conversions, build brand authority, and accelerate customer growth."
  },
  {
    "title": "eBay Store Design",
    "content": "Professional, end-to-end strategy, execution, and optimization for eBay Store Design to maximize conversions, build brand authority, and accelerate customer growth."
  },
  {
    "title": "PPC Campaign Management",
    "content": "Professional, end-to-end strategy, execution, and optimization for PPC Campaign Management to maximize conversions, build brand authority, and accelerate customer growth."
  },
  {
    "title": "Product Detail Optimization",
    "content": "Professional, end-to-end strategy, execution, and optimization for Product Detail Optimization to maximize conversions, build brand authority, and accelerate customer growth."
  },
  {
    "title": "Multi-channel Sync",
    "content": "Professional, end-to-end strategy, execution, and optimization for Multi-channel Sync to maximize conversions, build brand authority, and accelerate customer growth."
  },
  {
    "title": "Customer Feedback Management",
    "content": "Professional, end-to-end strategy, execution, and optimization for Customer Feedback Management to maximize conversions, build brand authority, and accelerate customer growth."
  }
]
        ...
        <div className={styles.container}>
          ...
          >
            <div className={styles.leftHero}>
              <span className={styles.sectionTag}>Amazon & eBay</span>
              <h1 className={styles.heroTitle}>
                Dominate <span className={styles.gradientText}>Marketplaces</span> With Direct SEO & PPC.
              </h1>
              <p className={styles.heroDesc}>
                Maximize organic visibility, optimize product descriptions, and run highly profitable PPC ads.
              </p>
        ...
        <div className={styles.container}>
          <div className={styles.overviewRow}>
            <div 
              ...
              aria-label="Amazon & eBay strategy" 
              style={{
          ...
          <div className={styles.bespokeGrid}>
            <div className={styles.bespokeLeft}>
              <h2 className={styles.sectionHeading}>Expand search impressions, <span className={styles.tealText}>capture buyer interest</span>, and convert clicks into checkout purchases.</h2>
              <p className={styles.bespokeText}>
                Marketplace sales require deep compliance and conversion tactics. At KR Tasker Digital, we set up robust storefront profiles, run precise product detail audits, and sync inventory models. Our advertising campaigns ensure your listings sit at the top of Amazon and eBay search rankings.
              </p>
            ...
            <div className={styles.bespokeRight}>
              ...
              <div className={styles.statBox}>
                <h3 className={styles.statVal}>200%+</h3>
                <p className={styles.statLabel}>Seller Revenue Growth</p>
        ...
        <div className={styles.container}>
          <div className={styles.featuresGrid}>
            <div 
              ...
              style={{
                backgroundImage: 'url(https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=600&auto=format&fit=crop)',
                backgroundSize: 'cover',
                backgroundPosition: 'center'
              }}
            >
