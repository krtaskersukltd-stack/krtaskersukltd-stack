        ...
        <div className={styles.container}>
          ...
          >
            <div className={styles.leftHero}>
              <span className={styles.sectionTag}>AI Automation</span>
              <h1 className={styles.heroTitle}>
                Intelligent <span className={styles.gradientText}>AI Systems</span> That Free Up Focus.
              </h1>
              <p className={styles.heroDesc}>
                Leverage custom artificial intelligence to automate repetitive tasks and optimize workflows.
              </p>
        ...
        <div className={styles.container}>
          <div className={styles.featuresGrid}>
            <div 
              ...
              style={{
                backgroundImage: 'url(https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=600&auto=format&fit=crop)',
                backgroundSize: 'cover',
                backgroundPosition: 'center'
              }}
            >
