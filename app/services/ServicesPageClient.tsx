...
const MAIN_SERVICES_DATA: MainServiceOffering[] = [
  ...
  },
  {
    ...
    subServices: [
      ...
      { name: 'Meta Ads', href: '/services/marketing' },
      { name: 'Facebook Ads', href: '/services/marketing' },
      { name: 'Microsoft Ads', href: '/services/marketing' },
      { name: 'LinkedIn Ads', href: '/services/marketing' },
      { name: 'TikTok Ads', href: '/services/marketing' },
      { name: 'X (Twitter) Ads', href: '/services/marketing' },
      { name: 'Conversion Tracking', href: '/services/ppc/conversion-tracking' },
    ],
  },
  {
    id: 'graphic-design',
  ...
  },
  {
    ...
    subServices: [
      ...
      { name: 'Email Campaign Management', href: '/services/email-marketing/email-campaign-management' },
      { name: 'Email Automation', href: '/services/email-marketing/email-automation' },
      { name: 'Email List Building', href: '/services/email-marketing/email-list-building' },
      { name: 'Email Design', href: '/services/email-marketing/email-design' },
      { name: 'Email Copywriting', href: '/services/email-marketing/email-copywriting' },
