...
export const SERVICES_QUERY = groq`
  *[_type == "service" && (!defined(status) || status == "published")] | order(sortOrder asc) {
    ...
    heroCtaText,
    heroCtaLink,
    "heroBannerImage": coalesce(heroBannerImage.asset->url, heroBannerImage),
    "heroBannerImageAlt": heroBannerImage.alt,
    capabilitiesEyebrow,
    capabilitiesHeading,
    capabilitiesCtaText,
    capabilitiesCtaLink,
    ...
    visionCtaText,
    visionCtaLink,
    "visionImage": coalesce(visionImage.asset->url, visionImage),
    "visionImageAlt": visionImage.alt,
    introHeading,
    introContent,
