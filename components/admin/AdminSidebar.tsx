...
const navItems: NavItem[] = [
  ...
  { label: 'Sanity Studio', href: '/studio', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
  ...
  { label: 'Header Navigation', href: '/admin/navigation', icon: 'M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' },
